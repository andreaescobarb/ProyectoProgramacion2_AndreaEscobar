            ...
            for (int j = 0; j < matriz[0].length; j++) {
                if (moverx == 0) {
                    if (matriz[moverx][movery - 1] instanceof Rebeldes) {
                        if (matriz[moverx][movery - 2] instanceof Duques || matriz[moverx][movery + 1] instanceof Rey) {
                    ...
                    if (matriz[moverx - 1][movery] instanceof Rebeldes) {
                        if (matriz[moverx - 2][movery] instanceof Duques || matriz[moverx - 2][movery] instanceof Rey) {
                            matriz[moverx - 2][movery] = new EspacioBlanco(' ');
                        }
                    }
                    if (matriz[moverx + 1][movery] instanceof Rebeldes) {
                        if (matriz[moverx + 2][movery] instanceof Duques || matriz[moverx + 2][movery] instanceof Rey) {
                    ...
                    if (matriz[moverx - 1][movery] instanceof Rebeldes) {
                        ...
                        if (matriz[moverx][movery + 2] instanceof Duques || matriz[moverx][movery + 2] instanceof Rey) {
                            matriz[moverx][movery + 2] = new EspacioBlanco(' ');
                        }
                    }
                } else if (movery == 18) {
                    if (matriz[moverx - 1][movery] instanceof Rebeldes) {
